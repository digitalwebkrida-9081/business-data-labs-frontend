...
export default function ServicesPage() {
  const services = [
    ...
    { title: "E-commerce Data Scraping Services", desc: "Extract valuable E-commerce data from any website. Scrape product details, pricing, deals, customer reviews, ratings, and seller information. Gain insights into consumer preferences and market trends.", wide: true, image: "images/service-page/4.png", href: "/service/ecom-scraping", accent: "#F59E0B" },
    { title: "Recruitment Data Scraping Services", desc: "Streamline your hiring process. Scrape job data from various sources, including the latest job listings, open vacancies, candidate profiles, company information, in-demand skills, and hiring locations.", image: "images/service-page/5.png", href: "/service/recruitment-scraping", accent: "#EC4899" },
    { title: "Travel and Leisure Data Scraping", desc: "Unlock valuable insights in the travel industry. Scrape travel data, such as hotel reviews, pricing, room availability, airline ticket prices, and more to optimize your offerings.", image: "images/service-page/6.png", href: "#", accent: "#8B5CF6" },
    { title: "Research and Journalism Data Scraping", desc: "Empower your research and journalism projects. Access a wealth of data on weather, development, crime, local and global trends to support your research or news stories.", wide: true, image: "images/service-page/7.png", href: "/service/research-data-scraping", accent: "#14B8A6" },
    { title: "Retail Store Data Scraping", desc: "Gain a competitive edge in the retail industry. Scrape vital information such as store openings, closures, parking convenience, in-store pickup options, services, and competitors.", image: "images/service-page/8.png", href: "/service/retail-data-scraping", accent: "#6366F1" },
    { title: "Brand Monitoring Data", desc: "Scrape data from vast sources across the web. Analyze customers' patterns, likes, dislikes, and many other details to protect your brand and monitor market sentiment.", image: "images/service-page/9.png", href: "#", accent: "#EF4444" },
    { title: "Manufacturing Industry Data Scraping", desc: "Revolutionize your manufacturing processes with data-driven insights. Identify consumer preferences, optimize resource usage, reduce waste, and improve machine productivity.", wide: true, image: "images/service-page/10.png", href: "#", accent: "#22D3EE" },
    { title: "Social Media Data Extraction Services", desc: "Harness the power of social media. Monitor platforms for posts, analyze sentiments, and create winning strategies by scraping valuable social media data.", image: "images/service-page/11.png", href: "#", accent: "#F59E0B" },
    { title: "News Monitoring Data Scraping", desc: "Stay informed about the latest events and trends. Extract news data about companies, products, and industries using our advanced web scraping technologies.", image: "images/service-page/12.png", href: "/service/news-monitoring-data-scraping", accent: "#10B981" },
  ];
    ...
    <>
      ...
      <section className="section-padding relative overflow-hidden" style={{ background: 'linear-gradient(135deg, var(--accent-primary), var(--accent-secondary))' }}>
        ...
        <div className="relative max-w-7xl mx-auto px-6 text-center">
          ...
          <Link href="/contact" className="inline-block bg-white text-indigo-700 font-bold text-sm px-8 py-3.5 rounded-xl hover:bg-indigo-50 transition shadow-xl">
            Get Started Today
          </Link>
        </div>
      </section>
